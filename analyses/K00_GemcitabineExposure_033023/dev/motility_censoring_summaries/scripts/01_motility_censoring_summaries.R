...
at_risk_rds <- args$at_risk_rds %||% file.path(analysis_dir, "dev/censoring_audit/staged/yellow_censoring_at_risk.rds")
censoring_model_rds <- args$censoring_model_rds %||%
  file.path(analysis_dir, "dev/censoring_audit/artifacts/censoring_models.rds")
out_dir <- normalizePath(
  args$out_dir %||% file.path(analysis_dir, "dev/motility_censoring_summaries/results"),
  mustWork = FALSE
)
...
message("Wrote motility/censoring prototype outputs to: ", out_dir)
